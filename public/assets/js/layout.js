...
var Layout = function () {
    ...
    var handleSidebarMenu = function () {
        ...
        $('.sidemenu-container-mobile-offcanvas .responsive-toggler').click(function() {
            $('body').toggleClass('sidemenu-container-mobile-offcanvas-open');
            e.preventDefault();
            e.stopPropagation();
        });
        ...
        if ($('body').hasClass('page-sidebar-mobile-offcanvas')) {
            $(document).on('click', function(e) {
                if ($('body').hasClass('sidemenu-container-mobile-offcanvas-open')) {
                    if ($(e.target).closest('.sidemenu-container-mobile-offcanvas .responsive-toggler').length === 0 && 
                        $(e.target).closest('.page-sidebar-wrapper').length === 0) { 
                        $('body').removeClass('sidemenu-container-mobile-offcanvas-open');
                        e.preventDefault();
                        e.stopPropagation();
                    }
                }                
        ...
        $('.sidemenu').on('click', ' li > .nav-link.ajaxify', function (e) {
            e.preventDefault();
			App.scrollTop();
            ...
            var menuContainer = $('.sidebar-container ul');
            var pageContent = $('.page-content');
            var pageContentBody = $('.page-content-wrapper');
            ...
            $.ajax({
                ...
                success: function (res) {
                    ...
                    if (that.parent('li').parent('.sidemenu').length === 1) {
