...
var App = function() {
    ...
    var assetsPath = base_url + 'public/assets/';
    ...
    var handleTheme = function() {
        ...
        $('.card .tools .t-collapse').click(function() {
        ...
        $('.card .tools .t-close').click(function() {
   ...
   var handleQuickSidebarToggler = function () {
       ...
       $('.dropdown-quick-sidebar-toggler a, .chat-sidebar-toggler, .quick-sidebar-toggler').click(function (e) {
   ...
   var handleQuickSidebarChat = function () {
       ...
       wrapper.find('.chat-sidebar-chat-users .media-list > .media').click(function () {
           wrapperChat.addClass("chat-sidebar-content-item-shown");
       });

       wrapper.find('.chat-sidebar-chat-user .chat-sidebar-back-to-list').click(function () {
        ...
        var handleChatMessagePost = function (e) {
           ...
           // handle post
           var time = new Date();
           var message = preparePost('out', (time.getHours() + ':' + time.getMinutes()), "Bob Nilson", 'doc/doc3', text);
           message = $(message);
           ...
           setTimeout(function(){
               var time = new Date();
               var message = preparePost('in', (time.getHours() + ':' + time.getMinutes()), "Ella Wong", 'doc/doc2', 'Lorem ipsum doloriam nibh...');
               message = $(message);
               chatContainer.append(message);
           }, 3000);
       };

       wrapperChat.find('.chat-sidebar-chat-user-form .btn').click(handleChatMessagePost);
       wrapperChat.find('.chat-sidebar-chat-user-form .form-control').keypress(function (e) {
           if (e.which == 13) {
    ...
    return {
        ...
        startPageLoading: function(options) {
            if (options && options.animate) {
                ...
                /**
                $('body').append('<div class="page-loading"><img src="' + this.getGlobalImgPath() + 'giphy.gif"/>&nbsp;&nbsp;</div>');
                */
            }
        },
